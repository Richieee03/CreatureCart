	...
	<div class="container mt-4">
		<div class="row justify-content-center">
			<div class="col-md-8 mb-5">
				...
				<a href="login.php"><button class="btn btn-block" style="border: 2px solid #CBD5E0; color:#67728A;height: 60px; border-radius:10px;">Login Sebagai Pelanggan</button></a>
			</div>
		</div>
	</div>
</section>
